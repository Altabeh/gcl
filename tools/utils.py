...
__all__ = ['create_dir', 'multiprocess', 'regex', 'sort_int', 'deaccent', 'normalize',
           'closest_value', 'hyphen_to_numbers', 'remove_repeated', 'validate_url']
...
def hyphen_to_numbers(string):
    ...
    '3 4 5'
    """
    string_lst = list(map(lambda x: re.sub(
        r'^-|-$', '', x), string.split(' ')))
    final_list = []
